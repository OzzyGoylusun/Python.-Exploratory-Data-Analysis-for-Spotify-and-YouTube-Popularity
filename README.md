...
2. There is **almost no correlation** identified between the popularity of a Spotify song and its total duration, with a coefficient value of -0.10. Nevertheless, it could be argued that composing slightly shorter songs could favour the artist to a small extent.
